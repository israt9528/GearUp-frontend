...
export function AdminOverviewSkeleton() {
  return (
    <div className="space-y-8">
      ...
      {/* ================= QUICK OVERVIEW BOTTOM SECTION SKELETON ================= */}
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        {/* System Health & Monitoring Skeleton */}
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between rounded-xl border border-border bg-muted/30 p-4">
              <div className="flex items-center gap-3">
                <div className="h-2.5 w-2.5 shrink-0 animate-pulse rounded-full bg-muted-foreground/30" />
                <div className="space-y-2">
                  <div className="h-4 w-40 animate-pulse rounded bg-muted" />
                  <div className="h-3 w-64 animate-pulse rounded bg-muted" />
                </div>
              </div>
              <div className="h-6 w-24 shrink-0 animate-pulse rounded-md bg-muted" />
            </div>
